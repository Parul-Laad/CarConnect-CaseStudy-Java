        ...
        try {
            ...
            while (!validInput) {
                ...
                try {
                    ...
                    throw new InvalidInputException("Invalid input. Please enter a valid integer for reservation ID.");
                }
            }
            ...
            if (isValidReservation != null) {
                System.out.println("Reservation Id " + reservationId + " already exists. Enter valid ReservationId.");
                return;
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (vehicle == null) {
                    	...
                    	System.out.println("The veicle with vehicle Id  " + vehicleId + " exists but is currently unavailable for reservation.");
                    	continue;
                    }
            ...
            while(true) {
            	try {
	            System.out.println("Do you want to change the reservation status from pending to confirmed? (yes/no)");
	            String changeStatusChoice = scanner.nextLine().toLowerCase();
	
	            if (changeStatusChoice.equals("yes")) {
	                reservation.setStatus(Status.confirmed); 
	                break;
	            } else if (!changeStatusChoice.equals("no")) {
	                throw new InvalidInputException("Invalid choice. Please enter 'yes' or 'no'.");
	            } else {
